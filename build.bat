...
if not exist bin\data\history mkdir bin\data\history
...
:: --- APP 4: SAGA PROJECTOR (Replay Viewer) ---
echo [BUILD] S.A.G.A. Projector...
%CXX% %CXXFLAGS% ^
    src/apps/App_Replay.cpp ^
    %SRC_COMMON% ^
    -o bin/SAGA_Projector.exe ^
    %LIBS%
