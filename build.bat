...
set SRC_COMMON=src/platform/WindowsUtils.cpp src/io/PlatformUtils.cpp src/io/BinaryExporter.cpp src/io/AssetManager.cpp src/io/stb_image_impl.cpp deps/imgui/imgui.cpp deps/imgui/imgui_draw.cpp deps/imgui/imgui_tables.cpp deps/imgui/imgui_widgets.cpp deps/imgui/backends/imgui_impl_glfw.cpp deps/imgui/backends/imgui_impl_opengl3.cpp
