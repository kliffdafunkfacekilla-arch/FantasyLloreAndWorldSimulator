...
struct WorldBuffers {
    ...
    // ^ Note: temperature is the variable name. User logic might refer to 'temp' - be careful in implementation.
    ...
    void clear() {
        ...
        delete[] temperature; delete[] moisture; delete[] flux;
        delete[] windDX; delete[] windStrength; delete[] windDY;
        delete[] population; delete[] speciesID; delete[] factionID; delete[] infrastructure;
