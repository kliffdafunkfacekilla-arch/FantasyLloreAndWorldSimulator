...
public:
    ...
    void GenerateProceduralTerrain(WorldBuffers& buffers, const WorldSettings& settings);
};
...
public:
    ...
    void RecordEvent(const ChronosConfig& time, std::string category, int cellID, std::string log);
